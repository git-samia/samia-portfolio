...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(cvs) {
      ...
      let g = cvs.getContext('webgl2', params);
      const isWebGL2 = !!g;
    ...
    function hashCode(s) { let hash = 0; for (let i = 0; i < s.length; i++) { hash = (hash << 5) - hash + s.charCodeAt(i); hash |= 0; } return hash; }
    ...
    function handleTouchEnd() { updatePointerUpData(pointers[0]); }
