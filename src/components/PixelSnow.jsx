...
export default function PixelSnow({
  ...
  useEffect(() => {
    ...
    const material = new ShaderMaterial({
      ...
      uniforms: {
        uTime: { value: 0 }, uResolution: { value: new Vector2(container.offsetWidth, container.offsetHeight) },
    ...
    return () => {
      ...
      renderer.dispose(); renderer.forceContextLoss(); geometry.dispose(); material.dispose();
  ...
  useEffect(() => {
    ...
    if (!m) return;
    m.uniforms.uFlakeSize.value = flakeSize;
    m.uniforms.uMinFlakeSize.value = minFlakeSize;
    m.uniforms.uPixelResolution.value = pixelResolution;
    m.uniforms.uSpeed.value = speed;
    m.uniforms.uDepthFade.value = depthFade;
    m.uniforms.uFarPlane.value = farPlane;
    m.uniforms.uBrightness.value = brightness;
    m.uniforms.uGamma.value = gamma;
    m.uniforms.uDensity.value = density;
    m.uniforms.uVariant.value = variantValue;
